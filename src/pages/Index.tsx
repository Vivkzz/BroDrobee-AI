    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="bg-white shadow-sm p-4">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-xl font-bold text-fashion-deep-purple">
            BroDrobe AI
          </h1>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 animate-fade-in">
            ...
            <p className="text-lg mb-8 text-gray-600">
              ...
              style preferences, and existing wardrobe. Let our AI be your
              fashion bestie!
            </p>
            <div className="space-x-4">
              <Link to="/auth">
            ...
            <div className="relative w-80 h-96 bg-fashion-purple rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                ...
                <p className="opacity-80 mb-2">
                  Try this outfit based on your wardrobe
                </p>
                <div className="bg-white bg-opacity-20 p-4 rounded-lg backdrop-blur-sm">
                  <p className="font-medium">
                    Navy blazer + white tee + dark jeans
                  </p>
                  <p className="text-sm opacity-80">
                    Perfect for your skin tone and tonight's weather!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="fashion-card p-6 text-center">
              ...
              <p className="text-gray-600">
                Take a quick style quiz to let our AI know your skin tone,
            ...
            <div className="fashion-card p-6 text-center">
              ...
              <p className="text-gray-600">
                Add photos of your favorite clothing items so our AI can work
                with what you have.
              </p>
            </div>
            ...
            <div className="fashion-card p-6 text-center">
              ...
              <p className="text-gray-600">
                Just ask, and our AI will suggest the perfect outfit for any
                occasion.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="mb-4 md:mb-0">
              © 2025 BroDrobe AI. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <a
                href="#"
                className="hover:text-fashion-purple transition-colors"
              >
                Privacy Policy
              </a>
              <a
